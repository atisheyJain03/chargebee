      ...
      <Grid container>
        <Grid container justify="space-between">
          ...
          <Grid item xs={12} md={5} style={{ marginTop: "50px !important" }}>
            <h4>Quote-to-Cash Automation</h4>
            <h1>Powers Sales and Marketing CRM</h1>
            <div className="cards__chip--div">
              <Chip
                size="small"
                label="Preffered Partner"
                className="cards__chip"
              />
            </div>
            <img src={cardImg2} loading="lazy" />
            <h2>
              Handle quotes, approvals, acceptance, and collections seamlessly
              from within the CRM.
            </h2>
