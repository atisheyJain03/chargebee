...
function Slider() {
  ...
  const lefth2 = [
    ...
    "ofessor at Hampden-Sydney College in Virginia",
    "more recently with desktop",
  ];
  const background_color = [
    "linear-gradient(180deg,#47499b 0,#242565 100%)",
    "linear-gradient(180deg,#f2a720 0,#bc7e0f 100%)",
    "linear-gradient(180deg,#438b8b 0,#124e4e 100%)",
  ];

  const rightPara = [
    "industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown prin a type specimen book. It has survivedessentially unc of Letraseassages, and more recently with desktop",
    ...
    <div className="slider">
      <Grid container className="slider-container">
        <Grid container justify="center">
          <Grid item xs={4} md={2}>
            {index === 0 ? (
              <h6 className="slider__h6">Rethink Pricing</h6>
            ) : (
          ...
          <Grid item xs={4} md={2}>
            {index === 1 ? (
              <h6 className="slider__h6">Automate FinOps</h6>
            ) : (
          ...
          <Grid item xs={4} md={2}>
            {index === 2 ? (
              <h6 className="slider__h6">Go Global</h6>
            ) : (
        ...
        <Grid container className="slider__grid--card">
          <Grid
            ...
            xs={12}
            md={5}
            style={{ background: background_color[index] }}
            className="slider__grid--left"
          >
            ...
            <Button className="slider__button" variant="outline">
              Learn more
            </Button>
          </Grid>
          <Grid item xs={12} md={7} className="slider__grid--right">
            ...
            <img src={image[index]} loading="lazy" />
          </Grid>
        </Grid>
      </Grid>
    </div>
